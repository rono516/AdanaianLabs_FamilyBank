                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                        <div class="featured__item">
                            ...
                            <div class="featured__item__text">
                                <h6><a href="{{url('product_details',$featuredProduct->id)}}">{{ $featuredProduct->product_name }}</a></h6>
                                <h5>Ksh. {{ number_format($featuredProduct->price,2) }}</h5>
                            </div>
                        </div>
                    </div>
                @endforeach
                                ...
                                @foreach($latestProducts as $latestProduct)
                                    <a href="#" class="latest-product__item">
                                        <div class="latest-product__item__pic">
                                            <img width="50" height="50" src="{{\Illuminate\Support\Facades\Storage::url($latestProduct->image_url)}}" alt="">
                                            {{-- ($featuredProduct->image_url) --}}
                                        </div>
                                        <div class="latest-product__item__text">
                                            <h6>{{$latestProduct->product_name}}</h6>
                                            <span>Ksh. {{number_format($latestProduct->price)}}</span>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
